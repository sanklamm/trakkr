(ns com.time-tracker.feat.app
  (:require [com.biffweb :as biff :refer [q]]
            ...
            [com.time-tracker.feat.tags :as tags]
...
(defn notify-clients [{:keys [com.time-tracker/chat-clients]} tx]
...
(defn ws-handler [{:keys [com.time-tracker/chat-clients] :as req}]
  {:status 101
...
(def features
  {:routes ["/app" {:middleware [wrap-signed-in]}
            ...
            ["/tags" {:post tags/tag-create
                      :get tags/tag-list}]
            ["/tags-new" {:get tags/new-tag-page}]
            ["/tags/:id" {:get tags/edit-tag-page
                          :delete tags/tag-delete
                          :post tags/tag-update}]
            ["/tags/:id/delete" {:post tags/tag-delete}]
            ["/chat" {:get ws-handler}]]
